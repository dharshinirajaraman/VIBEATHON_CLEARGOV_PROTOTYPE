 ...
 * stops defining one. This happens when an agent moves a component into
 * a new file and replaces the old module with a re-export:
 *
 *   export { default } from './app/App'
 *
 * Vite otherwise accepts the update using the previous module's HMR
 * boundary, but the re-export-only transform no longer registers a
 * replacement for the mounted component family. React reports a
 * successful refresh while leaving the old tree mounted until the
 * page is reloaded.
 */
